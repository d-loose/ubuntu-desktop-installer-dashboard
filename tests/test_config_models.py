...
def test_dashboard_data_serializes_nested_records():
    record = IsoRecord(
        ...
        subiquity_snap=PackageVersion(name="subiquity", version="1.2.3", revision="1234", channel="26.04/stable/ubuntu-26.04.1"),
        ...
        "records": [
            {
                ...
                "subiquity_snap": {"name": "subiquity", "version": "1.2.3", "revision": "1234", "channel": "26.04/stable/ubuntu-26.04.1"},
